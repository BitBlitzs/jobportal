<?php
/* Smarty version 4.3.4, created on 2023-12-06 17:13:44
  from 'c:\xampp\htdocs\tpl\template\index\register.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65703b4818bc82_80860422',
...
function content_65703b4818bc82_80860422 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <form method="post" name="form1" id="form1" action="" onSubmit="return check()" class="sign-in-form">
          ...
          <?php if (!empty($_smarty_tpl->tpl_vars['errormsg']->value)) {?>
            ...
            <?php }?>
              ...
              <div class="input-field">
                <i class="fas fa-lock"></i>
                <input type="password" name="again" placeholder="確認密碼" />
              </div>
              <div class="input-field">
                <i class="fas fa-user"></i>
